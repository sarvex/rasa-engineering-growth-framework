...
export type TrackId = 'DESIGN' | 'DOMAIN_EXPERTISE' | 
  'DELIVERY' | 'SCOPING' | 
  'EXPECTATION_MANAGEMENT' | 'CORE_COLLABORATION_SKILLS' | 'EQUITY_AND_INCLUSION'
  'MENTORSHIP' | 'OUTREACH' | 'RECRUITING' | 
  'PRODUCT_ACUMEN' | 'PRIORITIZATION'
...
export const tracks: Tracks = {
  "DESIGN": {
    ...
    "milestones": [{
      "summary": "Come up with solutions to solve the problem detailed in an issue following best practices established in the team.",
      "examples": [
        "Write testable, readable code keeping edge cases in mind.",
      ],
    }, {
      "summary": "Utilises abstractions and code isolation effectively. Maintain consistency across the code base and handles edge cases. Code review their own work and regularly review their teammates' work.",
      "examples": [
  ...
  "DOMAIN_EXPERTISE": {
    ...
    "milestones": [{
      "summary": "Learn to use existing tools at Rasa. Read our documentation and able follow the steps. Update our documentation if needed.",
      "examples": [
      ],
    }, {
      "summary": "Apply the principles of the programming language and framework they are working with. Demonstrate knowledge on industry trends.",
      "examples": [
        "Familiar with common pitfalls in cross-browser implementations.",
      ],
    }, {
      "summary": "Has expertise in multiple areas in the codebase in one technical domain. Understand the architecture. Understand the principles, inner-workings and limitations of the programming language and framework they are working with.",
      "examples": [
      ...
      "summary": "Go-to-expert of the team's ownership in one technical domain and developing expertise in other relevant areas. Ensure that Rasa is ahead of the curve.",
      "examples": [
  ...
  "DELIVERY": {
    ...
    "milestones": [{
      "summary": "Make steady progress on issues. Know when to ask for help to get themselves unblocked. Responsible for their own changes.",
      "examples": [
      ...
      "summary": "Able to drive and complete new assignments without the need for constant significant guidance from teammates. Deliver projects according to the product spec. Strive to keep estimates up to date and deliver those estimates.",
      "examples": [
      ...
      "summary": "Able to execute complex designs. Foresee impediments, mitigate them proactively before they become emergencies.",
      "examples": [
  ...
  "SCOPING": {
    ...
    "milestones": [{
      ...
      "summary": "Able to break features down into actionable issues so that they can be parallelized by the team.",
      "examples": [
      ],
    }, {
      ...
      "examples": [
        "Scope out the work for a major release.",
      ],
    }, {
  ...
  "CORE_COLLABORATION_SKILLS": {
    ...
    "category": "C",
    "description": "Be honest: share your opinions in an open and respectful manner to help the team and Rasa succeed.",
    "milestones": [{
      "summary": "Able to take technical and behavioral feedback in an open, respectful manner with a curious mindset. Able to follow existing team processes.",
      "examples": [
      ],
    }, {
      ...
      "summary": "Able to mediate discussions in a team. Able to de-escalate disagreements and resolve them with concensus. Resolve conflicts with teammates with compassion, patience and respect.",
      "examples": [
        "Lead discussions around team process improvements, get consensus and buy in to execute.",
      ],
    }, {
      "summary": "Maintain a pulse on teams' morale and help with retention. Able to motivate the teams to achieve their goals. Able to drive organizational changes.",
      "examples": [
  ...
  "EQUITY_AND_INCLUSION": {
    ...
    "category": "C",
    "description": "Respect is our code: diversity, equity and inclusion is the core of our mission. (Can opt out from IV)",
    "milestones": [{
      "summary": "Exhibits Rasa's core values. Contribute positively to a safe and inclusive team environment.",
      "examples": [
  ...
  "MENTORSHIP": {
    ...
    "milestones": [{
      "summary": "Seek out mentorship and help to grow their own experience. Share their learnings regularly with the team.",
      "examples": [
      ],
    }, {
      ...
      "summary": "Plan with the manager and mentor some team members. Prioritize the teammate's learning and avoid strong ego. Delivers reinforcing and corrective feedback to their mentees, teammates, and manager directly in a constructive manner.",
      "examples": [
  ...
  "RECRUITING": {
    ...
    "category": "D",
    "description": "Help Rasa grow by bringing in more Rasas. (Can opt out from III)",
    "milestones": [{
  ...
  "PRODUCT_ACUMEN": {
    ...
    "category": "E",
    "description": "Think for yourself: challenge our strategies and be an advisor for the product org.",
    "milestones": [{
      ...
      "summary": "Know how their squad's product features fit into the larger product scope. Understand a squad's domain and drive feature proposals along with product and / or design. Have the users in mind when building features.",
      "examples": [
      ...
      "summary": "Provide high-level product input and evaluate tradeoffs based on this insight. Continuously evaluates proposed product features with respect to better alternatives unknown to product management. Optimize for the users' need.",
      "examples": [
      ...
      "summary": "Well-researched about the Conversational AI industry. Able to drive product direction along with the product org. Able to align product and engineering goals when proposing engineering initiatives.",
      "examples": [
        "Work on the company product strategy deck."
      ],
    }],
  },
  ...
  "PRIORITIZATION": {
    ...
    "milestones": [{
      ...
      "summary": "Work with stakeholders to set priorities and scope across multiple competing projects on a team level. Able to handle multiple competing responsibilties.",
      "examples": [
      ],
    }, {
